...
var tracks = [
	{ "name": "From a broken heart", "file": preload("res://songs/From_a_broken_heart.mp3") },
	{ "name": "Millenial spleen", "file": preload("res://songs/Millenial_spleen.mp3") },
	{ "name": "Summer nights", "file": preload("res://songs/Summer_nights.mp3") }
]
